...
p2 = b & ~tb_mask == tb_val
p3 = a + b == c
p4 = ta_mask + tb_mask == sm
p5 = ta_val + tb_val == sv
p6 = sm + sv == sigma
p7 = sigma & sv == chi
p8 = chi | ta_mask | tb_mask == mu
p9 = sv & ~mu == out1
p10 = mu == out2
output = c & ~out2 == tc_val

formula = z3.ForAll([a, ta_val, ta_mask, b, tb_val, tb_mask, c, tc_val, tc_mask],
    z3.Implies(z3.And(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10), output))
